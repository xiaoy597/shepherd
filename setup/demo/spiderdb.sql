...
INSERT INTO `crawl_job` VALUES (2,1,'天气预报',1,1,0,0,1,0,0,0,'http://www.weather.com.cn/textFC/hunan.shtml',1,0),(7,1,'深交所证券成交量',0,1,0,0,1,0,0,0,'http://www.szse.cn/szseWeb/FrontController.szse?randnum=0.30835385089340417',1,0),(8,1,'丝路商机',0,1,0,0,1,0,0,0,'http://www.xinhuanet.com/silkroad/slsj.htm',1,0);
...
INSERT INTO `data_store_param` VALUES (1,1,'host','localhost'),(1,1,'passwd','spider'),(1,1,'port','3306'),(1,1,'user','spider');
...
-- Dump completed on 2020-05-22 14:59:44
